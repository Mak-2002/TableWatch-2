                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('employee.reservation.edit', $reservation->id) }}"
                                                                        style="size: 20px;">Edit</a>

                                                                    <form
                                                                        action="{{ route('employee.reservation.cancel', $reservation->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('put')
                                                                        <button class="dropdown-item" type="submit"
                                                                            style="color: rgb(72, 0, 255)">Cancel</button>
                                                                    </form>
                                                                    <form
                                                                        action="{{ route('employee.reservation.delete', $reservation->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <button class="dropdown-item" type="submit"
