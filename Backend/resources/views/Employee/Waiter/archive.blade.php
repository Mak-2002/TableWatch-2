...
<head>
    ...
    <title>Waiter Archive Table</title>
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('employee.waiter.restore', $waiter->id) }}"
                                                                        style="size: 20px;">Restore</a>
                                                                    <form
                                                                        action="{{ route('employee.waiter.forceDelete', $waiter->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('delete')
